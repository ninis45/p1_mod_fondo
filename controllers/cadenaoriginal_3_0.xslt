...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu">
	...
	-->
	<xsl:include href="cadenaoriginal_3_0/utilerias.xslt"/>
    <xsl:include href="cadenaoriginal_3_0/donat11.xslt"/>
    <xsl:include href="cadenaoriginal_3_2/valesdedespensa.xslt"/>
    <xsl:include href="cadenaoriginal_3_2/cfdiregistrofiscal.xslt"/>
	<!-- 
